...
The discriminant of the L.H.S is $\Delta=-27n^2-14n-3=-27\left(n+\frac{7}{27}\right)^2-\frac{32}{27}<0$ for all $n\in\\mathbb{N}$, so there exists only one real root. Explicitly, it is given by
...
1. <a id="Wilf2005"></a> Wilf, H. S. (2005). *generatingfunctionology* (3rd ed.). AK Peters/CRC. <a href="https://doi.org/10.1201/b10576" target="_blank" rel="noopener noreferrer">https://doi.org/10.1201/b10576</a>
